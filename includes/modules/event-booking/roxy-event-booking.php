...
require_once ROXY_EB_PLUGIN_DIR . 'includes/monitoring.php';
...
add_action('plugins_loaded', function () {
    ...
    if (!wp_next_scheduled(ROXY_EB_HEALTH_CHECK_HOOK)) {
        wp_schedule_event(time() + 2 * HOUR_IN_SECONDS, 'daily', ROXY_EB_HEALTH_CHECK_HOOK);
    }
});
