...
final class Admin {
    ...
    private static function render_meta_page(): void {
        echo '<h2>Meta Connection</h2><p>Connect the Facebook Page and Instagram professional account used for Roxy social posts. Nothing will publish until a draft is approved.</p>';
